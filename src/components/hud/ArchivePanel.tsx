...
export function ArchivePanel({ onClose }: ArchivePanelProps) {
  ...
  return (
    <DialogFrame
      ...
      panelClassName="pointer-events-auto flex h-[82vh] w-[760px] max-w-[95vw] flex-col overflow-hidden rounded-2xl border border-[#deff9a]/45 bg-black/80 p-0 text-white shadow-[0_0_80px_rgba(222,255,154,0.2)] backdrop-blur-md"
    >
      <div className="flex items-start justify-between gap-3 border-b border-white/10 bg-gradient-to-b from-[#deff9a]/[0.06] to-transparent px-7 py-5">
        <div>
          ...
          <h2 id="archive-dialog-title" className="mt-2 font-serif text-2xl tracking-widest text-white/95">
            Archive
          </h2>
        </div>
