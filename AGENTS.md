...
This project is indexed by GitNexus as **china-clara** (1080 symbols, 2264 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
