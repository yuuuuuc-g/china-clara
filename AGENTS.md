...
This project is indexed by GitNexus as **china-clara** (1211 symbols, 2617 relationships, 96 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
