...
This project is indexed by GitNexus as **china-clara** (950 symbols, 1842 relationships, 76 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
